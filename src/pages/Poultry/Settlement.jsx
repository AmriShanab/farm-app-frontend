                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        ...
                        <Egg size={16} className="text-amber-500 opacity-80" />
                      </div>
                    ...
                    <div
                      className={`border rounded-xl p-4 shadow-sm flex flex-col justify-between ${isProfit ? "bg-green-50/50 border-green-200" : "bg-red-50/50 border-red-200"}`}
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <p
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        ...
                        <Wheat size={16} className="text-red-500 opacity-80" />
                      </div>
                    ...
                    <div
                      className={`border rounded-xl p-4 shadow-sm flex flex-col justify-between ${isFinalReceivedPositive ? "bg-green-50/50 border-green-200" : "bg-red-50/50 border-red-200"}`}
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <p

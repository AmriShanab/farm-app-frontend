            ...
            <>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-[10px] text-gray-400 font-bold uppercase">Birds Sold</p>
                    <p className="font-bold text-blue-600">{parseInt(settlement.totalChicksSold || 0).toLocaleString()}</p>
                  </div>
                  <div>

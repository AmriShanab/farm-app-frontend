      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-xs font-medium text-gray-500 pl-11">
            Grid-style attendance register for the estate workforce
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap min-w-[600px]">
             <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                   <th className="py-3 px-5 text-[11px] font-bold uppercase tracking-wider text-gray-500 w-[40%]">Employee</th>
                   {/* Column Headers with quick visual indicators */}
             ...
             <tbody className="divide-y divide-gray-50">
               {filteredEmployees.length === 0 ? (
                 <tr>
                    <td colSpan="4" className="p-10 text-center text-gray-400 text-sm font-semibold">
                   ...
                   return (
                     <tr key={emp.id} className="hover:bg-gray-50/80 transition-colors group">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="flex items-center gap-1.5 text-[10.5px] text-gray-500 font-medium">
                                ...
                                <span className="text-green-700">{emp.farm}</span>
                              </div>
                            </div>
                          </div>
                       </td>
                       ...
                       <td className="py-3 px-2 text-center align-middle" onClick={() => handleStatusChange(emp.id, 1)}>
                          <div className="flex justify-center cursor-pointer p-2">
                             <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                               status === 1 ? 'border-green-500 bg-green-500 shadow-sm shadow-green-500/30' : 'border-gray-200 bg-gray-50 hover:border-green-300'
                             }`}>
                       ...
                       <td className="py-3 px-2 text-center align-middle" onClick={() => handleStatusChange(emp.id, 0.5)}>
                          <div className="flex justify-center cursor-pointer p-2">
                             <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                               status === 0.5 ? 'border-amber-400 bg-amber-400 shadow-sm shadow-amber-400/30' : 'border-gray-200 bg-gray-50 hover:border-amber-300'
                             }`}>
                       ...
                       <td className="py-3 px-2 text-center align-middle" onClick={() => handleStatusChange(emp.id, 0)}>
                          <div className="flex justify-center cursor-pointer p-2">
                             <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                               status === 0 ? 'border-red-500 bg-red-500 shadow-sm shadow-red-500/30' : 'border-gray-200 bg-gray-50 hover:border-red-300'
                             }`}>

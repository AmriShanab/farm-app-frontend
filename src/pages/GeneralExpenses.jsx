              ...
              <>
                ...
                <div className="md:col-span-4">
                  ...
                  <input
                    ...
                    className="w-full p-2.5 text-sm border border-gray-300 rounded-lg outline-none text-right font-black focus:border-green-500"
                  />
                </div>
                <div className="md:col-span-4">
                  <label className="block text-[11px] font-black text-gray-500 uppercase tracking-wider mb-1">
              ...
              <>
                ...
                <div className="md:col-span-6">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, ratePerLiter: e.target.value })
                    }
                    className="w-full p-2.5 text-sm border border-gray-300 rounded-lg outline-none text-right focus:border-green-500"
                  />
                </div>
                ...
                <tr>
                  ...
                  {(category === "maintenance" || category === "machinery") && (
                    <>
                      ...
                      <th className="p-4 text-left">Cheque Info</th>
                    </>
                  )}
                  {category === "ceb" && (
                    <>
                  ...
                  {category === "fuel" && (
                    <>
                      ...
                      <th className="p-4 text-right">Fuel Details</th>
                    </>
                  )}

...
export default function CoconutSales() {
  ...
  const handleExportCsv = () => {
    downloadCsv(`coconut-sales-${farmFilter}.csv`, [
        ...
        <div className="bg-gradient-to-b from-green-50 to-white border border-green-200 rounded-xl p-6 shadow-md mb-6 animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
            <div className="md:col-span-4">
              ...
              <input type="date" name="date" value={newRow.date} onChange={handleRowChange} className="w-full p-2.5 text-sm border border-gray-300 rounded-lg outline-none font-bold focus:border-green-500" disabled={isSaving} />
            </div>
            ...
            <div className="md:col-span-12 p-4 rounded-xl border border-green-100 bg-green-50/20 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-500 mb-1">Rate (Rs.)</label>
          ...
          <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-100">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Calculated Invoice Earnings</p>
              <p className="text-xl font-black text-green-700">Rs. {fmt(calcNet(newRow))}</p>
            </div>
            <div className="flex gap-3">
              ...
              <button onClick={handleSaveRow} disabled={isSaving} className="px-6 py-2.5 bg-green-600 rounded-lg text-white text-sm font-bold shadow-md hover:bg-green-700 flex items-center gap-2 transition-all">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <table className="w-full text-sm whitespace-nowrap">
            <thead className="bg-gray-50 text-gray-500 font-bold uppercase text-[10px] tracking-wider border-b border-gray-100">
              <tr>
                <th className="p-4 text-left w-12">
                  <input type="checkbox" onChange={toggleAll} checked={selected.length > 0 && selected.length === filtered.length} className="rounded border-gray-300 text-green-600 focus:ring-green-500 accent-green-700" />
                </th>
            ...
            <tbody>
                ...
                return (
                  <tr key={sale.id} className={`border-t border-gray-50 transition-colors ${isSel ? 'bg-green-50/40' : 'hover:bg-gray-50/40'}`}>
                    ...
                    <td className="p-4">
                      ...
                      <span className="text-[10px] text-gray-400 font-bold uppercase">{sale.farm ? `${sale.farm} Block` : '—'}</span>
                    </td>
              ...
              {!isLoading && filtered.length === 0 && (
                <tr><td colSpan={8} className="p-12 text-center text-gray-400 font-bold">No harvest distribution sales logs found for {farmFilter} block criteria.</td></tr>
              )}
            </tbody>
          </table>
        </div>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
          ...
          <div className="flex gap-1">
            ...
            <button className="px-3 py-1 text-xs font-black rounded bg-gradient-to-br from-green-700 to-green-800 text-white">1</button>
          ...
          <div className="bg-white w-full max-w-2xl rounded-[1.5rem] shadow-2xl border border-gray-100 overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95">
            <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-black text-gray-900">Update Yield Record</h2>
                  <p className="text-xs text-gray-400 font-medium">Modifying payload ID #{editSale.id}</p>
                </div>
              </div>
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="date" name="date" value={editRow.date} onChange={handleEditRowChange} className="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-gray-900 font-bold focus:border-green-500 focus:outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-black text-gray-500 uppercase tracking-wider mb-1.5">Block Source</label>
              ...
              <div className="p-4 rounded-xl border border-green-100 bg-green-50/20 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1">Rate (Rs.)</label>
            ...
            <div className="px-6 py-5 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-black text-green-800">Rs. {fmt(calcNet(editRow))}</p>
              </div>
